...
<template>
  <Layout imgUrl="/img/cocktail.jpg" :is-back-button-visible="!!ingredient || !!filter" :backFunction="removeList">
    <div v-if="!ingredient && !filter" class="home">
      ...
      <img class="home__image" src="/img/cocktails.png" width="345" height="120" alt="Пять разных коктейлей">
    </div>
